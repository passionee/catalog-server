                    ...
                    <table class="cart__table cart-table">
                        <thead class="cart-table__head">
                            <tr class="cart-table__row">
                                <th class="cart-table__column cart-table__column--image text-left" colspan="2">
                                    Item
                                </th>
                                <th class="cart-table__column cart-table__column--merchant">
                                    Merchant
                                </th>
                            ...
                            <tr v-for="item in cart.items" :key="item.id" class="cart-table__row">
                                <td class="cart-table__column cart-table__column--image">
                                    <div v-if="item.image" class="product-image">
                                        <AppLink :to="$url.cartProduct(item.id)" class="product-image__body">
                                ...
                                <td class="cart-table__column cart-table__column--product">
                                    <AppLink :to="$url.cartProduct(item.id)" class="cart-table__product-name">
                                        {{ item.label }}
                                    </AppLink>
                                ...
                                <td class="cart-table__column cart-table__column--merchant" data-title="Merchant">
                                    <template v-if="item.merchant">{{ item.merchant.label }}</template>
                                </td>
...
export default class Page extends Vue {
    ...
    async updateQuantities () {
        await this.$store.dispatch('cart/updateQuantities', {
            'itemQuantity': this.quantities.map(x => ({
                ...x,
